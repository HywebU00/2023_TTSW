...
$(function () {
  ...
  $('.chat_window')
    ...
    .click(function (e) {
      $('.chat_window')
        .hide()
        .css('transform', 'translateX(' + 360 + 'px)');
      chat_status = false;
      e.preventDefault();
    });
  // minimize
  ...
  if ($('[data-toggle="dropdown"]').length > 0) {
    $('[data-toggle="dropdown"]').click(function (event) {
      ...
      $(this).siblings('.dropdown-panel').slideToggle();
    });
    $('[data-toggle="dropdown"]').focusout(function () {
      $(this).siblings('.dropdown-panel').hide();
    });
  }
...
$(function () {
  // -------------------------------------------video_slider2
  if ($('.video2 .slider').length > 0) {
    $('.col-12 .video2 .slider ul,.col-12-full .video2 .slider ul').slick({
      lazyLoad: 'ondemand',
      dots: false,
      infinite: true,
      speed: 300,
    ...
    $('.col-6-6 .col .video2 .slider ul').slick({
      lazyLoad: 'ondemand',
      dots: false,
      infinite: true,
      speed: 300,
    ...
    $('.col-8-4 .col:nth-child(2n) .video2 .slider ul').slick({
      lazyLoad: 'ondemand',
      dots: false,
      infinite: true,
      speed: 300,
    ...
    $('.col-8-4 .col:nth-child(2n+1) .video2 .slider ul').slick({
      lazyLoad: 'ondemand',
      dots: false,
      infinite: true,
      speed: 300,
    ...
    $('.col-4-8 .col:nth-child(2n+1) .video2 .slider ul').slick({
      lazyLoad: 'ondemand',
      dots: false,
      infinite: true,
      speed: 300,
    ...
    $('.col-4-8 .col:nth-child(2n) .video2 .slider ul').slick({
      lazyLoad: 'ondemand',
      dots: false,
      infinite: true,
      speed: 300,
    ...
    $('.col-4-4-4 .col .video2 .slider ul').slick({
      lazyLoad: 'ondemand',
      dots: false,
      infinite: true,
      speed: 300,
    ...
    $('.col-3-3-3-3 .col .video2 .slider ul').slick({
      lazyLoad: 'ondemand',
      dots: false,
      infinite: true,
      speed: 300,
  ...
  // -------------------------------------------創新設計獎2
  if ($('.award2 .slider').length > 0) {
    $('.col-12  .award2 .slider > ul,col-12-full .award2 .slider > ul').slick({
      lazyLoad: 'ondemand',
      dots: false,
      infinite: true,
      speed: 300,
    ...
    $('.col-6-6  .award2 .slider > ul').slick({
      lazyLoad: 'ondemand',
      dots: false,
      infinite: true,
      speed: 300,
    ...
    $('.col-8-4 .col:nth-child(2n+1) .award2 .slider > ul').slick({
      lazyLoad: 'ondemand',
      dots: false,
      infinite: true,
      speed: 300,
    ...
    $('.col-8-4 .col:nth-child(2n) .award2 .slider > ul').slick({
      lazyLoad: 'ondemand',
      dots: false,
      infinite: true,
      speed: 300,
    ...
    $('.col-4-8 .col:nth-child(2n) .award2 .slider > ul').slick({
      lazyLoad: 'ondemand',
      dots: false,
      infinite: true,
      speed: 300,
    ...
    $('.col-4-8 .col:nth-child(2n+1) .award2 .slider > ul').slick({
      lazyLoad: 'ondemand',
      dots: false,
      infinite: true,
      speed: 300,
    ...
    $('.col-4-4-4 .col .award2 .slider > ul').slick({
      lazyLoad: 'ondemand',
      dots: false,
      infinite: true,
      speed: 300,
    ...
    $('.col-3-3-3-3 .col .award2 .slider > ul').slick({
      lazyLoad: 'ondemand',
      dots: false,
      infinite: true,
      speed: 300,
...
// -------------------------------------------newsBox_slider
if ($('.newsBox .slider').length > 0) {
  $('.newsBox .tabBar .listBox').slick({
    slidesToShow: 1,
    variableWidth: true,
    infinite: false,
    arrow: false,
  ...
  // -------------------------------------------2024 new product_slider
  $('.col-12 .newsBox .slider ul,.col-12-full .newsBox .slider ul').slick({
    lazyLoad: 'ondemand',
    dots: false,
    infinite: true,
    speed: 300,
  ...
  $('.col-6-6 .col .newsBox .slider ul').slick({
    lazyLoad: 'ondemand',
    dots: false,
    infinite: true,
    speed: 300,
  ...
  $('.col-8-4 .col:nth-child(2n) .newsBox .slider ul').slick({
    lazyLoad: 'ondemand',
    dots: false,
    infinite: true,
    speed: 300,
  ...
  $('.col-8-4 .col:nth-child(2n+1) .newsBox .slider ul').slick({
    lazyLoad: 'ondemand',
    dots: false,
    infinite: true,
    speed: 300,
  ...
  $('.col-4-8 .col:nth-child(2n+1) .newsBox .slider ul').slick({
    lazyLoad: 'ondemand',
    dots: false,
    infinite: true,
    speed: 300,
  ...
  $('.col-4-8 .col:nth-child(2n) .newsBox .slider ul').slick({
    lazyLoad: 'ondemand',
    dots: false,
    infinite: true,
    speed: 300,
  ...
  $('.col-4-4-4 .col .newsBox .slider ul').slick({
    lazyLoad: 'ondemand',
    dots: false,
    infinite: true,
    speed: 300,
  ...
  $('.col-3-3-3-3 .col .newsBox .slider ul').slick({
    lazyLoad: 'ondemand',
    dots: false,
    infinite: true,
    speed: 300,
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  $('.rcm_tabBox .rcm_tab button').on('click', function () {
    $(this).parent('.item').addClass('active').siblings('.item').removeClass('active');
    $('.rcm_contentBox .rcm_body').eq($(this).index()).addClass('active').siblings('.rcm_body').removeClass('active');
